...
- Sentry public client env vars (`VITE_SENTRY_*`) can be provided as runtime env vars in container deployments (for example Railway) and do not need Docker build args.
